...
export default function LanderThree() {
  ...
  const handleSend = (response) => {
    ...
    if (currentQuestion.tag) {
      let shouldTag = false;
      if (currentQuestion.id === 8 && (response === "Yes" || response === "No"))
        shouldTag = true;
      if (currentQuestion.id === 9 && response !== "No") shouldTag = true;
      if (currentQuestion.id === 10 && response === "I Own") shouldTag = true;
